/**
 * Function to retrieve all SCIM schema information from Veeva Vault.
 *
 * @returns {Promise<Object>} - The SCIM schema information.
 */
const executeFunction = async () => {
  ...
  try {
    ...
    const url = `https://${vaultDNS}/api/${version}/scim/v2/Schemas`;
...
const apiTool = {
  ...
  definition: {
    type: 'function',
    function: {
      name: 'retrieve_scim_schemas',
      description: 'Retrieve all SCIM schema information from Veeva Vault.',
      parameters: {
        type: 'object',
        properties: {},
        required: []
